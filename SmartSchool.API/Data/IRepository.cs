...
namespace SmartSchool.API.Data
{
    public interface IRepository
    {
        ...
        Professor[] GetAllPrefessoresByDisciplinaId(int disciplinaId, bool includeAlunos = false);
        Professor GetProfessoreById(int professorId, bool includeAlunos = false);
        Professor[] GetProfessoreByAlunoId(int alunoId, bool includeAlunos = false);
    }
}
